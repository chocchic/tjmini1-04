...
<body>
	...
	<form action="/admin/coupon/modify" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" value="취소" data-oper="list" onclick="window.location='/admin/coupon/list'"/>
				</td>
			</tr>
	...
	$(document).ready(function(){
		...
		$("button").click(function(e){
			...
			if(operation === 'list'){
				formObj.attr("action", "/admin/coupon/list"); // 게시판리스트 GET
