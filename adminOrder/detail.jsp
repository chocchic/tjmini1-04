...
<body>
	...
	<form action="/admin/order/modify" method="get" >
	...
	$(document).ready(function(){
		...
		$("button").click(function(e){
			...
			if(operation === 'delete'){
				formObj.attr("action", "/admin/order/deleteForm"); 
			}else if(operation === 'list'){
				formObj.attr("action", "/admin/order/list"); 
			}else if(operation === 'modify'){
				formObj.attr("action", "/admin/order/modifyForm");
			}
