...
<body>
	...
	<form action="/admin/alarm/modify" method="get" >
	...
	$(document).ready(function(){
		...
		$("button").click(function(e){
			...
			if(operation === 'delete'){
				formObj.attr("action", "/admin/alarm/deleteForm"); 
			}else if(operation === 'list'){
				formObj.attr("action", "/admin/alarm/list"); 
			}else if(operation === 'modify'){
				formObj.attr("action", "/admin/alarm/modifyForm");
			}
