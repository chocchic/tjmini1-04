...
<body>
	...
	<table>
		<tr>
			<td colspan="18" align="right">
				<button id="resist" onclick="window.location='/admin/alarm/writeForm'">알림등록</button>
			</td>
		</tr>
		<tr>
			<td>No.</td>
	...
	<div align="center">
		<form action="/admin/alarm/list" method="get">
			<select name="type">
				<option value=""
	...
	<form action="/admin/alarm/list" method="get" id="pagingForm">
	...
	<script>
		$(document).ready(function(){
			...
			$("a.paging_btn").click(function(e){
				...
				pagingForm.attr("action", "/admin/alarm/list"); 
			...
			$(".updateBtn").click(function(){
				...
				pagingForm.attr("action", "/admin/alarm/modifyForm"); 
			...
			$(".move").click(function(e){
				...
				pagingForm.find("input[name='mnum']").val($(this).attr("href2"));
				// 폼의 action 속성값 (이동할 주소) content로 변경 
				pagingForm.attr("action", "/admin/alarm/detail"); 
				pagingForm.submit();  // 서브밋! 이동!!
			});
			...
			$(".deleteBtn").click(function(){
				...
				// 폼의 action 속성값 (이동할 주소) content로 변경 
				pagingForm.attr("action", "/admin/alarm/deleteForm");
				pagingForm.submit();  // 서브밋! 이동!!
			});
			...
			$("#resist").click(function(){
				...
				// 폼의 action 속성값 (이동할 주소) content로 변경 
				pagingForm.attr("action", "/admin/alarm/writeForm");
				pagingForm.submit();  // 서브밋! 이동!!
			});
