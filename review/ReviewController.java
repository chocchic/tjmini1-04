...
public class ReviewController {
	...
	public void content(@RequestParam("rnum") Integer rnum, Model model) {
	...
	public void myReviewList(ReviewVO vo, Model model) { //,@RequestParam("mnum") Integer mnum 나중에 합치고 mnum 넘겨줘야 함 
		model.addAttribute("list",reviewS.myReviewList());
	}
