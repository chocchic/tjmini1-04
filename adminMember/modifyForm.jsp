...
<body>
	...
	<form action="/admin/mMember/modify" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>주소 우편번호</td>
				<td><input type="text" name="mpnum" value="${member.mpnum}"/></td>
			</tr>
			<tr>
				<td>희망 영양소</td>
				<td>
	...
	$(document).ready(function(){
		...
		$("button").click(function(e){
			...
			if(operation === 'list'){
				formObj.attr("action", "/admin/mMember/list"); // 게시판리스트 GET
