...
<body>
	...
	<form action="/admin/mMember/modify" method="get" >
	...
	$(document).ready(function(){
		...
		$("button").click(function(e){
			...
			if(operation === 'delete'){
				formObj.attr("action", "/admin/mMember/deleteForm"); 
			}else if(operation === 'list'){
				formObj.attr("action", "/admin/mMember/list"); 
			}else if(operation === 'modify'){
				formObj.attr("action", "/admin/mMember/modifyForm");
			}
