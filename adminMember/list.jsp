...
<body>
	...
	<div align="center">
		<form action="/admin/mMember/list" method="get">
			<select name="type">
				<option value=""
	...
	<form action="/admin/mMember/list" method="get" id="pagingForm">
		<input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}" />
		<input type="hidden" name="listQty" value="${pageMaker.cri.listQty}" />
	...
	<script>
		$(document).ready(function(){
			...
			$("a.paging_btn").click(function(e){
				...
				pagingForm.attr("action", "/admin/mMember/list"); 
			...
			$(".updateBtn").click(function(){
				...
				pagingForm.attr("action", "/admin/mMember/modifyForm"); 
			...
			$(".authBtn").click(function(){
				...
				pagingForm.find("input[name='mnum']").val($(this).attr("href"));
				// 폼의 action 속성값 (이동할 주소) content로 변경 
				pagingForm.attr("action", "/admin/mMember/authForm");
				pagingForm.submit();  // 서브밋! 이동!!
			...
			$(".move").click(function(e){
				...
				// 폼의 action 속성값 (이동할 주소) content로 변경 
				pagingForm.attr("action", "/admin/mMember/detail"); 
				pagingForm.submit();  // 서브밋! 이동!!
				pagingForm.find("input[name='auth']").val("");
			});
