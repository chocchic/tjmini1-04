...
<body>
	...
	<form action="/admin/product/modify" method="get" >
	...
	$(document).ready(function(){
		...
		$("button").click(function(e){
			...
			if(operation === 'delete'){
				formObj.attr("action", "/admin/product/deleteForm"); 
			}else if(operation === 'list'){
				formObj.attr("action", "/admin/product/list"); 
			}else if(operation === 'modify'){
				formObj.attr("action", "/admin/product/modifyForm");
			}
